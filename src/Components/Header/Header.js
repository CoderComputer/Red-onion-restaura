                    ...
                    <li className="nav-item btnStyle">
                        {
                            ...
                            <Link to="/" className="nav-link">
                                <button style={{borderRadius:'20px'}} onClick={() => {auth.signOut()}} className="btn btn-danger btn-rounded">Sign Out</button>
                            </Link>
                            :
                            <Link to="/login" className="nav-link">
                                <button style={{borderRadius:'20px'}} className="btn btn-danger btn-rounded">Sign Up</button>
                            </Link>
                        }
